...
import SecondMockup from '../../assets/images/titan-storage-slide/second mockup2.webp';
    ...
    return (
        <div className="bg-[#F8FFFD] min-h-screen text-gray-900 font-sans selection:bg-[#B4F7E1]/30 selection:text-black overflow-x-hidden">
            ...
            <section className="py-32 px-6 md:px-[80px] bg-[#F8FFFD] relative overflow-hidden">
                ...
                <div className="max-w-[90rem] mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start relative">
                        ...
                        <div className="hidden lg:block absolute top-0 bottom-0 left-1/2 w-px bg-black/10 -translate-x-1/2" />

                        {/* Left Column */}
                        <div className="flex flex-col justify-between h-full space-y-12 lg:space-y-24">
                            <FadeIn>
                                <div className="flex items-baseline gap-4">
                                    <span className="text-6xl md:text-8xl font-light text-gray-900 tracking-tighter">01</span>
                                    <span className="text-sm font-mono text-gray-400 uppercase tracking-widest">[ About the project ]</span>
                                </div>
                            </FadeIn>
                            ...
                            <FadeIn delay={0.2} className="mt-8 lg:mt-auto">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h4 className="text-gray-900 font-bold">Joel K</h4>
                                        <p className="text-xs text-gray-500 uppercase tracking-wider">Founder, Titan Storage Solutions</p>
                                    </div>
                                </div>
                                <blockquote className="text-gray-600 text-lg leading-relaxed max-w-md">
                        ...
                        <div className="space-y-12 pt-4">
                            <FadeIn delay={0.4}>
                                <h2 className="text-3xl md:text-5xl leading-tight font-light text-gray-800">
                            ...
                            <FadeIn delay={0.6} className="flex flex-wrap gap-3">
                                {["Industrial Engineering", "Storage Tanks", "Pressure Vessels", "Piping & Structural", "Heavy Storage"].map((tag, i) => (
                                    <span key={i} className="px-6 py-3 rounded-full border border-black/10 text-gray-500 text-sm hover:border-black/30 hover:text-black transition-colors duration-300">
                                        {tag}
                                    </span>
                                ))}
                            </FadeIn>
            ...
            <section className="py-[50px] px-6 md:px-[80px] bg-[#121212] text-gray-100 relative overflow-hidden mx-4 md:mx-[30px] rounded-[45px] mb-[50px]">
                {/* Background Shapes */}
                <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-[#1E1E1E] rounded-bl-full opacity-50 pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-[#1E1E1E] rounded-tr-full opacity-50 pointer-events-none" />
                ...
                <div className="max-w-8xl mx-auto relative z-10">
                    <FadeIn>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 -mt-12">
                            <div /> {/* Spacer */}
                            <p className="text-2xl md:text-4xl text-gray-300 font-light leading-tight tracking-tight">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Persona 1: Mark */}
                            <div className="bg-[#1E1E1E] p-8 rounded-[2.5rem] shadow-sm flex flex-col gap-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-2xl font-bold text-white">Mark, 48</h3>
                                ...
                                <div className="space-y-2">
                                    <h4 className="font-bold text-xl text-gray-200">Profile:</h4>
                                ...
                                <div className="mt-auto space-y-2">
                                    <h4 className="font-bold text-xl text-gray-200">Pain Points:</h4>
                                    <p className="text-sm text-gray-400 leading-relaxed">
                            ...
                            <div className="bg-[#1E1E1E] p-8 rounded-[2.5rem] shadow-sm flex flex-col gap-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-2xl font-bold text-white">Sanjay, 35</h3>
                            ...
                            {/* Goals Card (Light) */}
                            <div className="bg-white text-gray-900 p-8 rounded-[2.5rem] shadow-xl flex flex-col gap-8">
                                ...
                                <ul className="space-y-6">
                                    {[
                                        ...
                                        <li key={i} className="flex gap-4 items-start">
                                            <div className="w-2 h-2 mt-2 rounded-full bg-gray-900 shrink-0" />
                                            <div>
                                                <p className="text-sm font-bold mb-1 text-gray-800">{goal.title}</p>
                                                <p className="text-sm text-gray-600 leading-relaxed font-sans">{goal.desc}</p>
                                            </div>
                                        </li>
                                    ))}
                                </ul>
            ...
            <section className="py-24 px-6 md:px-[80px] bg-white text-gray-900 border-t border-black/5 font-sans">
                <div className="max-w-8xl mx-auto">
                    {/* Header */}
                    <FadeIn>
                        <div className="flex justify-between items-start mb-24 border-b border-black/10 pb-8">
                    ...
                    <FadeIn delay={0.2}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start lg:items-center mb-12 md:mb-32 border-b border-black/10 pb-12 md:pb-24">
                            <div>
                                <h2 className="text-6xl md:text-8xl lg:text-[12rem] leading-none font-medium tracking-tighter text-gray-900 break-words">Manrope</h2>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 border-t md:border-t-0 md:border-l border-black/10 pt-8 md:pt-0 md:pl-12">
                                <div className="space-y-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl text-gray-700">36 / 80</p>
                                </div>
                                <div>
                                    <h4 className="text-gray-500 text-lg mb-4">Letter Spacing</h4>
                                    <p className="text-xl text-gray-700">0</p>
                                </div>
                            </div>
                        </div>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.4}>
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            {/* Cards Column */}
                            <div className="lg:col-span-10 divide-y divide-black/10 border-b border-black/10">
                                ...
                                {/* Color 2: Dark Obsidian (Replacing White) */}
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-8">
                                    <p className="text-gray-600 text-lg leading-relaxed">
                                        In this inverted theme, Deep Obsidian becomes the primary color for technical data and headings, ensuring maximum contrast and legibility on light backgrounds.
                                    </p>
                                    <div className="relative h-64 bg-[#191A19] rounded-[2rem] p-8 flex flex-col justify-between shadow-2xl">
                                        <div className="flex justify-end">
                                            <h3 className="text-5xl font-light text-white">Deep Obsidian</h3>
                                        </div>
                                        <div className="flex justify-between items-end">
                                            <span className="text-white/30 font-mono text-sm">02</span>
                                            <div className="text-right font-mono text-xs text-gray-200 space-y-1">
                                                <p>HEX: #191A19</p>
                                                <p>RGB: 25. 26. 25</p>
                                ...
                                {/* Color 3: Pure White (Replacing Obsidian) */}
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-8">
                                    <p className="text-gray-600 text-lg leading-relaxed">
                                        Pure white now serves as the foundation, providing a clean, open space that emphasizes the precision of the industrial diagrams and mocks.
                                    </p>
                                    <div className="relative h-64 bg-white rounded-[2rem] p-8 flex flex-col justify-between shadow-2xl border border-black/10">
                                        <div className="flex justify-end">
                                            <h3 className="text-4xl text-right font-light text-black leading-tight">Pure <br /> White</h3>
                                        </div>
                                        <div className="flex justify-between items-end">
                                            <span className="text-black/30 font-mono text-sm">03</span>
                    ...
                    <FadeIn>
                        <div className="flex justify-between items-end mb-24">
                            <div>
                                ...
                                <h2 className="text-6xl md:text-8xl font-light text-gray-900 tracking-tighter">
                                    Full Preview
                                </h2>
                            </div>
                            <div className="hidden md:block">
                                <p className="text-gray-600 max-w-md text-right leading-relaxed">
            ...
            <section className="pt-16 pb-24 px-6 md:px-[60px] bg-[#121212] text-gray-100 mx-4 md:mx-[30px] rounded-[45px] mb-[50px]">
                <div className="max-w-8xl mx-auto">
                    {/* Header */}
                    <FadeIn>
                        ...
                        <div className="lg:col-span-8">
                            <div className="divide-y divide-white/10 border-b border-white/10">
                                ...
                                <FadeIn delay={0.1}>
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-16 items-start">
                                        <div className="md:col-span-2">
                                            <span className="text-8xl font-light text-white/10">01</span>
                                        </div>
                                        ...
                                        <div className="md:col-span-2 flex justify-end">
                                            <span className="inline-block px-4 py-2 rounded-full bg-white/5 text-xs font-bold text-gray-400 uppercase tracking-wider">1 Week</span>
                                        </div>
                                    </div>
                                </FadeIn>
                                ...
                                <FadeIn delay={0.2}>
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-16 items-start">
                                        <div className="md:col-span-2">
                                            <span className="text-8xl font-light text-white/10">02</span>
                                        </div>
                                        <div className="md:col-span-8">
                                ...
                                <FadeIn delay={0.3}>
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-16 items-start">
                                        <div className="md:col-span-2">
                                            <span className="text-8xl font-light text-white/10">03</span>
                                        </div>
                                        <div className="md:col-span-8">
                                ...
                                <FadeIn delay={0.4}>
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-16 items-start">
                                        <div className="md:col-span-2">
                                            <span className="text-8xl font-light text-white/10">04</span>
                                        </div>
                                        <div className="md:col-span-8">
                                        ...
                                        <div className="md:col-span-2 flex justify-end">
                                            <span className="inline-block px-4 py-2 rounded-full bg-white/5 text-xs font-bold text-gray-400 uppercase tracking-wider">2 Weeks</span>
                                        </div>
                                    </div>
                                </FadeIn>
                            </div>
                ...
                <div className="max-w-8xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start relative">
                        ...
                        <div className="flex flex-col justify-between h-full space-y-12 lg:space-y-24">
                            <FadeIn>
                                <div className="flex items-baseline gap-4">
                                    <span className="text-6xl md:text-8xl font-light text-gray-900 tracking-tighter">06</span>
                                    <span className="text-sm font-mono text-gray-400 uppercase tracking-widest">[ CONCLUSION & FEEDBACK ]</span>
                                </div>
                            </FadeIn>
            ...
            <section className="py-32 px-6 md:px-[80px] bg-[#F8FFFD] border-t border-black/5">
                <div className="max-w-4xl mx-auto text-center">
                    <FadeIn>
                        ...
                        <a href="mailto:madhankannan29@gmail.com" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-black text-white font-semibold text-lg hover:bg-[#FF7420] hover:text-white transition-all duration-300">
                            Start a Project
