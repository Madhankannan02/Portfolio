...
export default function ButcherBox() {
    return (
        <div className="bg-stone-50 min-h-screen text-stone-900 font-sans selection:bg-red-100 selection:text-red-900 overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative min-h-screen flex flex-col justify-center items-center px-4 overflow-hidden bg-[#0a0a0a] text-white pt-20">
                ...
                <div className="z-10 text-center max-w-5xl mx-auto relative mt-[-5vh]">
                    <FadeIn delay={0.2}>
                    ...
                    <FadeIn delay={0.4}>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-medium mb-8 tracking-tight leading-[1.1]">
                ...
                {/* Hero Laptop Image */}
                <FadeIn delay={0.8} className="relative z-10 w-full max-w-4xl mx-auto mt-8 md:-mt-20 px-4">
                ...
                >
                    <span className="text-[10px] uppercase tracking-[0.2em]">Explore Case Study</span>
